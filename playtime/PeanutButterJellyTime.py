...
if pb >=1:
	if jelly >=1:
		if bread >=2:
			print "you have everything you need for a tasty sandwich!"
		else:
			print "So close, but you need more bread!"
	else:
		print "You don't have enough jelly to make any sandwiches. Sad."
else: 
	print "You need more peanut butter! Chunky plz."
...
if pb >=1:
	if jelly >=1:
		if bread >=2:
			...
			print "you only have enough jelly to make {0} sandwiches".format(jelly)
	else: 
		print "You don't have enough jelly to make any sandwiches. Sad."
else:
	print "You need more peanut butter! Chunky plz."		
	...
	if jelly >=1:
		if bread >=2:
			if (bread%2)==0:
				...
				print "You can make {0} regular sandwiches and {1} open faced sandwiches".format(bread/2,bread%2)
		else:
			print "you only have enough jelly to make {0} sandwiches".format(jelly)
	else: 
		print "You don't have enough jelly to make any sandwiches. Sad."
